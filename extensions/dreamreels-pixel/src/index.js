...
/**
 * Dream Reels purchase attribution.
 *
...
// domain moves.
const ORIGIN = "https://dreamreels.91.239.208.85.sslip.io";

const ATTR_VIDEO = "_dreamreels_video";
const ATTR_WIDGET = "_dreamreels_widget";
const ATTR_SESSION = "_dreamreels_session";
...
function orderKey(checkout) {
  ...
  if (checkout && checkout.token) {
    return `dreamreels://checkout/${checkout.token}`;
  }
  return null;
}
...
register(({ analytics, settings, init }) => {
  ...
  analytics.subscribe("checkout_completed", (event) => {
    ...
    // No Dream Reels attribute means this sale had nothing to do with a video.
