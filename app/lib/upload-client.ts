 ...
 * through Dream Reels, and a dropped connection resumes rather than restarting.
 *
...
export async function startUpload(
  ...
  try {
    ...
    return { ok: false, error: "Couldn't reach Dream Reels. Check your connection and try again." };
  }
