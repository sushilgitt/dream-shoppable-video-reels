...
export const ATTR_VIDEO = "_dreamreels_video";
export const ATTR_WIDGET = "_dreamreels_widget";
export const ATTR_SESSION = "_dreamreels_session";
...
/** Reads the Dream Reels cart attributes off an orders/create webhook payload. */
