 ...
 */
export const meta = () => [
  { title: "Dream Reels — Shoppable videos for Shopify" },
  {
    name: "description",
    content:
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 19, color: "#5c6b70", margin: "0 0 32px" }}>
        Dream Reels turns the videos you already post — Instagram reels, YouTube
      ...
      <p style={{ margin: "0 0 12px", color: "#5c6b70" }}>
        Dream Reels reads your products so you can tag them, and reads media from
