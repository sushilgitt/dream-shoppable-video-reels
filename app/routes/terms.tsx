...
export const meta = () => [
  { title: "Terms of Service — Dream Shoppable Video Reels" },
  {
    name: "description",
    content: "The terms under which merchants may use Dream Reels.",
  },
];
...
export default function Terms() {
  return (
    <LegalPage
      ...
      intro="These terms govern use of Dream Reels. By installing the app on your Shopify store you agree to them."
    >
      <Section heading="The service">
        <p style={{ margin: 0 }}>
          Dream Reels lets you import videos from sources you control, tag your
      ...
      <Section heading="Acceptable use">
        <ul style={listStyle}>
          <li>Do not use Dream Reels for unlawful, deceptive or infringing content</li>
          <li>
      ...
      <Section heading="Third-party services">
        <p style={{ margin: 0 }}>
          Dream Reels depends on Shopify, Meta (Instagram) and Google (YouTube).
      ...
      <Section heading="Liability">
        <p style={{ margin: 0 }}>
          Dream Reels is provided &ldquo;as is&rdquo;, without warranties of any
