 ...
 */
export const meta = () => [
  { title: "Privacy Policy — Dream Shoppable Video Reels" },
  {
    name: "description",
    content:
      "How Dream Reels collects, uses and stores data for merchants and shoppers.",
  },
];
...
export default function Privacy() {
  return (
    <LegalPage
      ...
      intro="Dream Reels turns a merchant's own Instagram reels and YouTube videos into shoppable videos on their Shopify storefront. This policy explains exactly what we collect, why, and how long we keep it."
    >
      <Section heading="Who we are">
        <p style={{ margin: 0 }}>
          Dream Reels is a Shopify application operated by the developer contactable
          at <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a>. In data
          protection terms, the merchant installing Dream Reels is the controller of
          their store and shopper data; Dream Reels acts as a processor on their
          behalf.
        </p>
      </Section>
      ...
      <Section heading="Store data we collect">
        <p style={{ margin: "0 0 8px" }}>
          When a merchant installs Dream Reels, we read the following from the
      ...
      <Section heading="Instagram data">
        ...
        <p style={{ margin: 0 }}>
          Dream Reels cannot post, comment, message or delete anything on Instagram.
          A merchant may disconnect at any time, and removing Dream Reels from their
      ...
      <Section heading="YouTube data">
        ...
        <p style={{ margin: 0 }}>
          ...
          discarded — it is never stored. Dream Reels&rsquo;s use of information received
      ...
      <Section heading="Your rights and how to exercise them">
        ...
        <ul style={listStyle}>
          ...
          <li>
            <strong>Instagram users:</strong> removing Dream Reels from your
