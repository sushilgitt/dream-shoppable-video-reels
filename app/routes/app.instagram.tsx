    ...
    <s-page heading="Instagram">
      ...
      {!configured && (
        <s-section heading="Instagram isn't set up yet">
          <s-paragraph>
            Dream Reels needs Meta app credentials before merchants can connect
      ...
      {configured && !connected && (
        <s-section heading="Connect your Instagram account">
          <s-paragraph>
            Dream Reels imports reels from your own Instagram Business or Creator
            account. You&rsquo;ll sign in with Instagram directly — no Facebook Page
            required.
          </s-paragraph>
          <s-paragraph>
            <s-text color="subdued">
              Dream Reels only reads your media. It cannot post, comment or message
              on your behalf.
            </s-text>
          </s-paragraph>
