    ...
    <s-page heading="TikTok">
      {!bunnyReady && (
        <s-section heading="Video hosting isn't connected yet">
          <s-paragraph>
            Dream Reels streams video through Bunny Stream. Add your library ID,
        ...
        <s-section heading="Connect your TikTok account">
          <s-paragraph>
            <s-text color="subdued">
              Dream Reels only accepts videos from an account you have proven is
        ...
        <s-section heading="Add your TikTok posts">
          <s-paragraph>
            <s-text color="subdued">
              ...
              time. Dream Reels checks each one belongs to @{username}, then adds
                    ...
                    {!video.hosted &&
                      (uploading?.id === video.id ? (
                        ...
                        <s-drop-zone
                          ...
                          onDropRejected={() =>
                            setNotice(
                              "That file isn't a video Dream Reels can upload.",
                            )
                          }
      ...
      <s-section slot="aside" heading="Getting your video files">
        <s-paragraph>
          <s-text color="subdued">
            A video with its file plays from Dream Reels&rsquo;s own CDN: it
