    ...
    <s-page heading="Videos">
      {!bunnyReady && (
        <s-section heading="Video hosting isn't connected yet">
          <s-paragraph>
            Dream Reels streams video through Bunny Stream. Add your library ID, API
      ...
      <s-section heading="Upload video">
        <s-paragraph>
          <s-text color="subdued">
            ...
            Dream Reels and large uploads resume if the connection drops.
          </s-text>
        </s-paragraph>
        <s-drop-zone
          label="Video files"
          ...
          onDropRejected={() =>
            setNotice("That file isn't a video Dream Reels can upload.")
          }
